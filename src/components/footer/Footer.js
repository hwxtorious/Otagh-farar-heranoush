                        ...
                        <ul className={classes.menuUl}>
                            <li className={classes.menuItem}>
                                <Typography variant='caption' className='item'>
                                    آدرس: تهران - سهروردی - بلوار بیژن - پلاک ۱۳
                                </Typography>
                            </li>
                            <li className={classes.menuItem}>
                                <Typography variant='caption' className='item'>
                                    شماره تماس: 09120000000 - 09120000000
                                </Typography>
                            </li>
                            <li className={classes.menuItem}>
                                <Typography variant='caption' className='item'>
                                    اینستاگرام: Heranoush_Escaperoom
                                </Typography>
                            </li>
                        </ul>
                    </div>
                ...
                <Grid item xs={12} md={4} className={classes.footerItemBox}>
                    ...
                    <Hidden mdDown>
                        <div className={classes.copyrightBox}>
                            <Typography variant='caption' className='caption silver-color'>تمامی حقوق مادی و معنوی این سایت متعلق به مجموعه اتاق فرار لژیون هرانوش میباشد</Typography>
                            <Typography variant='caption' className='silver-color'>©2024 Heranoush Legion Escape Room. All Rights Reserved.</Typography>
                        </div>
                    </Hidden>
                </Grid>
                <Grid item xs={12} md={4} className={classes.footerItemBox}>
