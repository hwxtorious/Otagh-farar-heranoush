            ...
            <div className={classes.main}>
                ...
                <Grid container direction="column" >
                    ...
                    <div className={classes.birthDayBox}>
                        <div className={classes.contentBox}>
                            <Card className={classes.birthdayCard}>
                                <Title englishTitle="birthday party" persianTitle="مراسم تولد در اتاق فرار لژیون هرانوش " />
                                <div className={`${classes.description} ${classes.birthdaydesc}`}>
                                    ...
                                    <Typography variant='caption' className='caption text-2'>
                                        مجموعه لژیون هرانوش افتخار این را دارد در محیطی آرام و دلنشین میزبان مراسم با شکوه تولدتان بوده تا یک شب رویایی وخاطره انگیزی را برای شما عزیزان گرامی رقم بزند.
                                    </Typography>
                    ...
                    <div className={classes.gmaesContainer}>
                        <Title englishTitle="mirage games" persianTitle="بازی های اتاق فرار هرانوش" />
                    ...
                    <div className={classes.aboutUs}>
                        <div className={classes.aboutUsBox}>
                            <Card className={classes.aboutUsCard}>
                                ...
                                <div className={classes.description}>
                                    <Typography variant='caption' className='caption text-2'>
                                        متفاوت ترین هارا در اتاق فرار لژیون هرانوش تجربه کنید
                                    </Typography>
                                    <Typography variant='caption' className='caption text-2'>
                                        اتاق فرار لژیون هرانوش در سال 2024 ایجاد شد
                                    </Typography>
                                    <Typography variant='caption' className='caption text-2'>
                                        اولین بازی اتاق فرار طراحی شده توسط  لژیون هرانوش "میراژ(سراب)" نام دارد
                                    </Typography>
                                </div>
                            </Card>
                        </div>
                        <div className={classes.contactUsBox}>
                            <Card className={classes.aboutUsCard}>
                                ...
                                <div className={classes.description}>
                                    <Typography variant='caption' className='caption text-2'>
                                        <AlternateEmailIcon className={classes.Icon} /> ایمیل: Heranoush@gmail.com
                                    </Typography>
                                    <Typography variant='caption' className='caption text-2'>
                                        <ContactPhoneIcon className={classes.Icon} /> شماره تماس: 09120000000 - 09120000000
                                    </Typography>
                                    <Typography variant='caption' className='caption text-2'>
                                        <InstagramIcon className={classes.Icon} /> اینستاگرام: Heranoush_Escaperoom
                                    </Typography>
                                </div>
                            </Card>
                        </div>
